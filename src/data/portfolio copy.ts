...
export const profile = {
  ...
  title: "Analista de Sistemas & Dados | Sankhya ERP | PL/SQL | Node.js | Qlik Sense | Automação de Processos",
  summary:
    `ou Analista de Sistemas e Dados com mais de 16 anos de experiência em Automação Comercial e gestão de ERPs.
 
Atualmente na MQ Professional Hair Styling, atuo de forma generalista gerenciando e evoluindo o ERP Sankhya, onde desenvolvo novas funcionalidades, automações e soluções sob medida. Minha atuação inclui:
 
Administração e customização do Sankhya (PL/SQL, JavaScript e Java)
Criação de Dashboards e relatórios com SQL, iReport e Qlik Sense
Desenvolvimento de Views, Procedures, Triggers e queries otimizadas para Oracle
Suporte ao time de Power BI com criação de views e ETL
Desenvolvimento de APIs para integrações financeiras, RH e conciliações
Criação de aplicações internas com Node.js, PostgreSQL, Vue.js e React para automação de processos (Sellout, Uploader de mídia, Leitor de PDF, Pré-vendas, etc.)
 
Tenho sólida formação em Administração de Banco de Dados e vasta experiência anterior como Analista de Testes, Product Owner, Administrador de Banco de Dados (PostgreSQL) e Implantação de sistemas ERP, incluindo conhecimento em legislação tributária e fiscal (Sped, Sintegra, interface com bancos).
 
Busco oportunidades onde possa continuar entregando soluções técnicas práticas que geram eficiência e automatização real para o negócio.`,
  email: "hugofquinteiro@gmail.com",
